...
<button class="toggle-abs" onclick="toggleAbstract('desc-are133', this)">Course Description</button> &nbsp; <button class="toggle-abs" onclick="toggleAbstract('evals-are133', this)">Student evaluations (excerpt)</button>
