...
<button class="toggle-abs" onclick="toggleAbstract('taste-for-taxes', this)">show abstract</button>                 
...
* The Pollution–Productivity Curve: Non-linear Effects and Adaptation in High-pollution Environments (with Faraz Usmani) *Draft available upon request*<br>
  <button class="toggle-abs" onclick="toggleAbstract('abs-pollution-productivity-r', this)">show abstract</button>
...
- “Does An Innovation’s Reach Reveal Anything About Its Impact? Under The Right Conditions: Possibly.” 2025. Rome, Italy: Standing Panel on Impact Assessment. With Travis Lybbert and Madeleine Walker. [Link to PDF](http://mspitzerbrooks.github.io/files/TN12_SPIA_Innovation_Reach.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-spia-reach’, this)”>show abstract</button>
...
- “Evaluation of the Liberia Compact’s Mt. Coffee Hydropower Plant Rehabilitation and Capacity Building and Sector Reform: Findings from the Final Round.” 2024. Washington, DC: Mathematica. With Candace Miller, et al. [Link to PDF](http://mspitzerbrooks.github.io/files/Liberia-Energy-Final-Report.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-liberia-energy-final’, this)”>show abstract</button>
...
- “Liberia Energy Project: Findings from the Final Evaluation of the Pipeline Sub-Activity.” 2024. Washington, DC: Mathematica. With Poonam Ravindranath, Paolo Abarcar, Cullen Seaton, and Candace Miller. [Link to PDF](http://mspitzerbrooks.github.io/files/Liberia-Pipeline-Evaluation.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-liberia-pipeline’, this)”>show abstract</button>
...
- “Maternal Health Care Quality Improvement in Rajasthan, India: Insights from a Development Impact Bond Verification Agent.” 2021. Washington, DC: Mathematica. With So O’Neil, Divya Vohra, Shveta Kalyanwala, and Dana Rotz. [Link to PDF](http://mspitzerbrooks.github.io/files/Utkrisht_Endline_Report.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-utkrisht-endline’, this)”>show abstract</button>
...
- “Jordan Refugee Livelihoods Development Impact Bond Evaluation Framework.” 2021. Washington, DC: Mathematica. With Evan Borkum, Paolo Abarcar, and Laura Meyer. [Link to PDF](http://mspitzerbrooks.github.io/files/Mathematica-RefugeeDIB_Evaluation framework.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-jordan-dib’, this)”>show abstract</button>
...
- “Maternal Health Care Quality and Outcomes Under the Utkrisht Impact Bond: Midline Findings and Insights.” 2020. Washington, DC: Mathematica. With So O'Neil, Divya Vohra, Dana Rotz, and Shveta Kalyanwala. [Link to PDF](http://mspitzerbrooks.github.io/files/DIB_Midline_report.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract('abs-utkrisht-midline', this)”>show abstract</button>
...
- “Evaluation of the Liberia Power Compact’s Mt. Coffee Hydropower Plant Rehabilitation and Capacity Building and Sector Reform: Baseline and Interim Findings.” 2020. Washington, DC: Mathematica. With Candace Miller, et al. [Link to PDF](http://mspitzerbrooks.github.io/files/finalreport-lbr-energy-mchpp-sep20.pdf)<br>
  <button class=”toggle-abs” onclick=”toggleAbstract(‘abs-liberia-baseline’, this)”>show abstract</button>
